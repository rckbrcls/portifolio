...
- **Labs articles:** Labs details use the same continuous article body as Work and Blog. Each product has one MDX narrative that combines product context, engineering decisions, and current outcomes without tabs or hash-addressed views.
