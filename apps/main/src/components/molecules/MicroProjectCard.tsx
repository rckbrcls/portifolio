...
const MicroProjectCard = ({ project }: IMicroProjectCardProps) => {
  ...
  return (
    <div
      className={`glass-dark group flex transform-gpu select-none flex-col justify-between overflow-hidden rounded-3xl delay-75 duration-500 hover:-translate-y-1`}
