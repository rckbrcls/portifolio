      ...
      <div className="flex w-full flex-col-reverse md:flex-row">
        <div className="flex w-full select-none flex-col gap-2 p-10 text-left max-md:p-5 md:w-2/3">
          ...
          <div className="flex gap-2">
            {project?.gitLink && (
              <a
                className="glass-dark flex w-full items-center justify-center gap-2 text-nowrap rounded-lg px-6 py-2 text-xl font-black transition duration-500 hover:scale-[1.01] hover:bg-zinc-900 active:scale-95 active:bg-zinc-900 md:h-16"
