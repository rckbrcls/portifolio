    ...
    >
      <div className="flex size-full flex-row items-center justify-between gap-5 p-14">
        ...
        <div className="flex flex-col justify-center gap-20">
          ...
          <Circle className="size-20 max-md:size-16" ref={divRefReact}>
            <SiReact size={50} />
          </Circle>
          <Circle className="size-20 max-md:size-16" ref={divRefNextJS}>
            <SiNextdotjs size={50} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle className="size-20 max-md:size-16" ref={divRefWebpack}>
            <SiWebpack size={50} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center">
          <Circle className="size-20 max-md:size-16" ref={divRefMain}>
